...
<body class="bg-white text-gray-900">
  ...
  <div class="bg-[#121212] text-white border-b border-gray-800 h-9 shadow-sm">
    <div class="max-w-7xl mx-auto h-full px-0 lg:px-6 flex items-center justify-between text-sm">
  
      <!-- Country Selector (Visible on Mobile & Desktop) -->
      ...
      <div class="hidden md:flex items-center h-full">
        ...
        <!-- Navigation -->
        <nav class="flex items-center gap-7 font-medium mr-0">
